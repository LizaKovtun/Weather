...
function getStats(data) {
  ...
  UV_index.innerHTML = `
    <p style="color: #6B6B6B; font-size: 15.4px;">UV Index</p>
  ...
  wind_status.innerHTML = `
    <p style="color: #6B6B6B; font-size: 15.4px;">Wind Status</p>
    ...
    <p style="color: #6B6B6B; font-size: 15.4px;">Sunrsie & Sunset</p>
    ...
    `
   humidity.innerHTML = `
    <p style="color: #6B6B6B; font-size: 15.4px;">Humidity</p>
   ...
   visibility.innerHTML = `
    <p style="color: #6B6B6B; font-size: 15.4px;">Visibility</p>
   ...
   `
    pressure.innerHTML = `
    <p style="color: #6B6B6B; font-size: 15.4px;">Pressure</p>
...
function phoneWeek() {
   ...
   weekText.style.marginTop = '-40vh'
   body.style.height = '87.7vh';
   weeknstats.style.marginTop = '40vh';
   weeknstats.style.height = '86vh';
}
function phoneStats() {
   let hWeek =  document.getElementById("week-text");
   let hTH = document.getElementById("TH-text");
   ...
   body.style.height = '121.7vh';
   weeknstats.style.marginTop = '95%';
   weeknstats.style.height = '140vh';
}
function phoneLoc() {
   let hWeek =  document.getElementById("week-text");
   let hTH = document.getElementById("TH-text");
   ...
   stats.style.display = 'none';
   body.style.height = '87.7vh';
   weeknstats.style.marginTop = 'none';
   weeknstats.style.height = '86vh';
}
